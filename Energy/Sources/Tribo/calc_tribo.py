...
#@jit
def calc_power(tileCount, pedStepsPerTile, tileEff, tilePower):
    '''
    ...
    .. note:: The vendor does not provide specific power generated per step.  
    The power generated is assumed to be 1,000,000 steps = 1kWh (1mWh / step) based on a telecon with PaveGen.
    ...
    return tileCount * pedStepsPerTile * tileEff * tilePower
